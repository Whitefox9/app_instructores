  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[0.95rem] text-sm font-semibold transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 ring-offset-background",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border/90 bg-card text-foreground hover:bg-muted/70",
        ghost: "text-muted-foreground hover:bg-muted/80 hover:text-foreground",
      },
      size: {
        default: "h-11 px-4.5 py-2",
        sm: "h-9 rounded-[0.85rem] px-3.5",
        lg: "h-12 rounded-[1rem] px-6 text-base",
        icon: "h-11 w-11 rounded-[0.95rem]",
      },
    },
    defaultVariants: {
      variant: "default",
