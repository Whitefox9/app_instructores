...
export const roleProfiles: Record<UserRole, RoleProfile> = {
  ...
  coordinador: {
    ...
    summary: "Consola operativa para instructores, fichas, ambientes, colegios y asignaciones.",
    quickAction: "Crear nueva asignacion",
...
export const navigationByRole: Record<UserRole, NavItem[]> = {
  ...
  coordinador: [
    ...
    { href: "/coordinador/colegios", label: "Articulacion", icon: "school" },
    { href: "/coordinador/ambientes", label: "Ambientes", icon: "door-open" },
    { href: "/coordinador/asignaciones", label: "Asignaciones", icon: "git-branch-plus" },
    { href: "/coordinador/importacion-excel", label: "Importaciones", icon: "sheet", badge: "Beta" },
    { href: "/coordinador/programas", label: "Planeacion", icon: "book-open-text" },
  ],
  instructor: [
